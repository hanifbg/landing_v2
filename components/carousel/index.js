...
const CarouselGallery = () => {
  ...
  return (
    <Carousel thumbnailWidth={tWidth} hasDotButtons={false} hasIndexBoard={false} hasLeftButton={false} hasRightButton={false} hasSizeButton={false} hasMediaButton={false} images={img} style={{ height: 500, width: 500 }} />
  );
};
