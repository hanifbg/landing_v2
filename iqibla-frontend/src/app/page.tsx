...
export default function HomePage() {
  ...
  return (
    ...
    <main className="min-h-screen">
      ...
      <section className="relative w-full h-screen page-content-padding">
        {" "}
        {/* Added page-content-padding */}
        <Swiper
          modules={[Pagination]}
          slidesPerView={1}
          loop={true}
          pagination={{ clickable: true }}
          className="w-full h-full hero-slider" // Added hero-slider class for mobile styling
        >
          {/* Slide 1: Salat Counter */}
          <SwiperSlide className="relative bg-black flex items-center justify-center overflow-hidden">
            {/* Background Image Container */}
            <div className="image-container salat-counter-image">
              {/* Desktop Image */}
              <Image
              ...
              {/* Mobile Image */}
              <Image
                src="/images/mobile-shalat-counter.webp"
                alt="Salat Counter Product Mobile"
                fill={false}
                width={200}
                height={200}
                className="md:hidden absolute inset-0 object-contain object-center opacity-70 scale-100"
                priority
              />
            </div>
            {/* Content Overlay */}
            <div className="absolute inset-0 bg-black/50 flex flex-col justify-end md:justify-center p-4 md:p-8 lg:p-16 text-white">
              <div className="max-w-xl text-center md:text-left mx-auto md:mx-0 px-4">
                <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-4">
                  {t("home.salatCounter")}
                </h1>
                <p className="text-base md:text-lg lg:text-xl mb-6 md:mb-8">
                  {t("home.salatCounterDesc")}
                </p>
                <Link
                  href="https://iqibla.com/products/salat-counter"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 md:py-4 px-6 md:px-8 rounded-lg transition-colors duration-200 shadow-lg"
                >
                  {t("common.learnMore")}
                </Link>
              </div>
          ...
          <SwiperSlide className="relative bg-black flex items-center justify-center overflow-hidden">
            ...
            {/* Content Overlay */}
            <div className="absolute inset-0 bg-black/50 flex flex-col justify-end p-4 md:p-8 lg:p-16 text-white">
              <div className="max-w-xl text-center md:text-left mx-auto md:mx-0 px-4">
                <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold mb-4">
                  {t("home.zikrPremium")}
                </h1>
                <p className="text-base md:text-lg lg:text-xl mb-6 md:mb-8">
                  {t("home.zikrPremiumDesc")}
                </p>
                <Link
            ...
            <div className="flex flex-col md:flex-row md:space-x-8 items-center">
              ...
              <div className="w-full md:w-1/5 mb-8 md:mb-0">
                <h3 className="text-2xl font-semibold text-green-600 mb-4">
                  {t("home.whatIsIqiblaLife")}
                </h3>
                <p className="text-gray-700 mb-4">
                  {t("home.iqiblaLifeDesc1")}
                </p>
          ...
          <div className="container mx-auto px-4 mt-12">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-green-50 rounded-xl p-6 shadow-md overflow-hidden flex flex-col justify-between min-h-[800px]">
                <div>
                  <h3 className="text-xl font-semibold text-green-600 mb-4">
                    {t("home.holyQuranPlayer")}
                  </h3>
                  <p className="text-gray-700 mb-6">
                    {t("home.holyQuranPlayerDesc")}
                  </p>
                </div>
                <div className="w-full relative h-[450px] rounded-lg overflow-hidden mt-auto">
                  ...
                  >
                    <source
                      src="/videos/holy-quran-player.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
              ...
              <div className="bg-green-50 rounded-xl p-6 shadow-md overflow-hidden flex flex-col justify-between min-h-[800px]">
                <div>
                  <h3 className="text-xl font-semibold text-green-600 mb-4">
                    {t("home.prayerTimeReminders")}
                  </h3>
                  <p className="text-gray-700 mb-6">
                    {t("home.prayerTimeRemindersDesc")}
                  </p>
                </div>
                <div className="w-full relative h-[450px] rounded-lg overflow-hidden mt-auto">
                  <video
                  ...
                  >
                    <source
                      src="/videos/prayer-time-reminders.mp4"
                      type="video/mp4"
                    />
                  </video>
                </div>
              ...
              <div className="bg-green-50 rounded-xl p-6 shadow-md overflow-hidden flex flex-col min-h-[600px]">
                <div className="flex flex-col md:flex-row gap-6 h-full">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-green-600 mb-4">
                      {t("home.downloadIqiblaLife")}
                    </h3>
                    <p className="text-gray-700 mb-6">
                      {t("home.downloadIqiblaLifeDesc")}
                    </p>
                    ...
                    <p className="text-sm text-gray-600">
                      The app is ready right now! Try it out
                    </p>
                  </div>
